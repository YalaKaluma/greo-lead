    ...
    <div className="rounded-lg border border-blue-100 bg-blue-50 p-5 shadow-sm">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-300"
        >
      ...
      {review ? (
        <div className="mt-5 space-y-5">
          ...
          {review.recommended_focus && (
            <div className="rounded-md border border-blue-100 bg-white/70 p-4">
            ...
            <div>
              ...
              <div className="mt-3 grid gap-3">
                {review.mtn_actions.map((action, index) => (
                  <div key={`${action.title}-${index}`} className="rounded-md border border-blue-100 bg-white p-4">
