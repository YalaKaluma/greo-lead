...
const STEPS = [
  ['my-goals', 'Your vision', 'Great leadership starts with a clear destination. This page is where Alfred turns your ambition into a primary vision, strategic pillars, and concrete outcomes so you can see how direction connects to progress. You can find here the strategic goals we briefly discussed earlier. I also divided them into strategic pillars that you can see when you click into each goal. For your reference, I also included a couple of goals most frequently used by my clients. Feel free to review, adjust, or delete them.'],
