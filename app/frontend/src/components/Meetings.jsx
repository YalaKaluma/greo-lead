...
function LeadershipDomainWheel({ assessments = [] }) {
  ...
  return <div className="grid gap-6 lg:grid-cols-[320px_1fr] lg:items-center">
    <div>
      <svg viewBox="0 0 300 300" className="mx-auto w-full max-w-[300px]" role="img" aria-label={t('meetings.leadership.wheelAria')}>
        ...
        <text x="150" y="144" textAnchor="middle" className="fill-white text-base font-semibold">{t('meetings.leadership.hub')}</text>
        <text x="150" y="164" textAnchor="middle" className="fill-amber-300 text-xs">{t('meetings.leadership.hubFeedback')}</text>
      </svg>
