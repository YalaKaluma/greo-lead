...
class JourneyPerson(Base):
    ...
    circle_type = Column(String, nullable=True)
    strategic_importance = Column(String, nullable=True)
    last_interaction_at = Column(DateTime, nullable=True)
    next_action = Column(Text, nullable=True)
    current_goals = Column(Text, nullable=True)
    development_plan = Column(Text, nullable=True)
    stretch_assignments = Column(Text, nullable=True)
    ...
    stakeholder_strengths = Column(Text, nullable=True)
    risks_or_pressures = Column(Text, nullable=True)
    stakeholder_aspirations = Column(Text, nullable=True)
    how_i_create_value = Column(Text, nullable=True)
    mission_alignment = Column(Text, nullable=True)
    potential_tensions = Column(Text, nullable=True)
    relationship_strategy = Column(String, nullable=True)
...
class AuditLog(Base):
    ...
    object_id = Column(String(120), nullable=True)
    metadata_json = Column(JSONB, nullable=True)
