    ...
    def compile_context(
        ...
        *,
        ...
        return {
            ...
            "twin_snapshot_id": core_snapshot.id if core_snapshot is not None else None,
            "twin_prompt_version": core_snapshot.prompt_version if core_snapshot is not None else None,
            "twin_model_version": core_snapshot.model_version if core_snapshot is not None else None,
            "evidence_count": int(evidence_count),
            "source_count": int(source_count),
